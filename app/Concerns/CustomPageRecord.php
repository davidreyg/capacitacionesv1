...
/**
 * Esta clase es para gestionar custom resource pages.
 * Tiene la misma funcionalidad de un edit con algunos reajustes.
 * Modificamos el metodo authorizeAccess para usar el canAccess que tu definas
 * Dicho esto, debes usar el metodo canAccess para gestionar el acceso a esta pagina :)
 * @author David Rey Gutierrez
 * @copyright (c) 2024
 */
class CustomPageRecord extends Page
{
