...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('anexo_unos', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('empresa_empleador_id');
            $table->foreign('empresa_empleador_id')->references('id')->on('establecimientos');

            // EMPRESA DONDE LABURA - DEBERIA SER DONDE TRABAJA
            $table->unsignedBigInteger('empresa_laboral_id');
            $table->foreign('empresa_laboral_id')->references('id')->on('establecimientos');
            $table->timestamps();
